...
def load_class_names_from_data2000(data_root):
    ...
    # 尝试从配置文件加载类别
    try:
        config_path = "/home/ubuntu/lsn/project_new/RT-DETR-main/rtdetrv2_pytorch/configs/rtdetrv2/rtdetrv2_r18vd_cancer_detection.yml"
...
def calculate_classification_metrics(predictions_file, ground_truth_file, iou_threshold=0.5, data_root="/home/ubuntu/lsn/project_new/RT-DETR-main/DATA/SputumCell/split_dataset"):
    """
    计算目标检测模型的分类效果指标
